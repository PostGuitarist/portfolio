/* empty css                                 */
import { e as createComponent, k as renderComponent, l as renderScript, r as renderTemplate, h as createAstro, n as renderSlot, g as addAttribute, o as renderHead, m as maybeRenderHead, p as Fragment } from '../chunks/astro/server_BH2AzcIm.mjs';
export { renderers } from '../renderers.mjs';

const basics = {"name":"Zaden Connell","label":"Software Developer @ Samaritan's Purse","image":"/me_avatar.png","email":"me@zadenconnell.com","url":"https://zadenconnell.com","summary":"Software Developer @ Samaritan's Purse | Co-Founder @ SwiftSeg","theme":"default","location":{"city":"Boone","region":"North Carolina"},"profiles":[{"network":"LinkedIn","username":"zaden-connell","url":"https://linkedin.com/in/zaden-connell"},{"network":"X","username":"ConnellZaden","url":"https://x.com/ConnellZaden"},{"network":"GitHub","username":"PostGuitarist","url":"https://github.com/PostGuitarist"}]};
const work = [{"name":"Samaritan's Purse","position":"Software Developer","location_type":"On site","location":"Boone, North Carolina","url":"https://www.samaritanspurse.org","startDate":"2025-07-22","endDate":null},{"name":"SwiftSeg","position":"Co-Founder & Lead Developer","location_type":"Remote","location":"Remote","url":"https://www.swiftseg.com","startDate":"2024-06-01","endDate":null,"summary":"Developed scalable web applications, integrated Supabase, and improved team efficiency at SwiftSeg.","responsibilities":["Developed and maintained scalable, responsive web applications using Next.js, enhancing user experience and reducing page load times by 40%.","Integrated Supabase as a backend and database solution for real-time data management, authentication, and storage, streamlining development.","Contributed to Agile Kanban workflows, improving team efficiency and workflow through effective communication."],"achievements":["Developed a web application from scratch that increased user engagement by 30%.","Reduced page load times by 40% through performance optimization.","Integrated Supabase as a backend and database solution, streamlining development."],"skills":["Web Development","Next.js","Supabase","Agile Development","Communication","Performance Optimization","User Experience","Scalability","Real-time Data Management","Authentication","Team Efficiency"]},{"name":"Liberty Analytical Support Initiative","position":"Intelligence & Security Advisor","location_type":"On site","location":"Lynchburg, Virginia","url":"https://www.liberty.edu","startDate":"2025-01-02","endDate":"2025-05-01","summary":"Conducted critical intelligence analysis and presented strategic recommendations to senior Department of Defense leadership, contributing to U.S. national security decision-making processes.","responsibilities":["Conducted extensive research, analysis and framed analytical recommendations on topics pertaining to U.S. national security.","Presented to the Office of the Under Secretary of Defense and the Joint Staff Strategic Plans & Policy Directorate.","Traveled to the Department of Defense at the U.S. Pentagon."],"achievements":["Delivered strategic intelligence briefings to senior DoD leadership at the Pentagon, influencing national security policy decisions.","Conducted comprehensive research and analysis on critical U.S. national security topics, producing actionable recommendations.","Presented findings to the Office of the Under Secretary of Defense and Joint Staff Strategic Plans & Policy Directorate.","Gained direct access to classified intelligence environments and high-level government decision-makers."],"skills":["Intelligence","Security","Advisory"]},{"name":"Liberty Analytical Support Initiative","position":"AI Developer & Advisor","location_type":"On site","location":"Lynchburg, Virginia","url":"https://www.liberty.edu","startDate":"2024-08-01","endDate":"2024-12-31","summary":"Presented on AI strategy, implementation, and ethical considerations in enhancing cultural competency to NATO Security Force Assistance leaders.","responsibilities":["Presented a custom trained AI chat-bot to NATO in Rome, Italy.","Led the development of a AI chatbot that equiped international security force advisors with the knowledge and skills to enhance cultural competency.","Created training materials and reccomendations for AI implementation in international security force assistance.","Analyzed current NATO SFA training programs and reccomended AI integration strategies."],"achievements":["Developed an AI chatbot that equipped international security force advisors with the knowledge and skills to enhance cultural competency.","Traveled to NATO SFA headquarters in Rome, Italy to present."],"skills":["AI Development","AI Strategy","Training & Development"]},{"name":"Samaritan's Purse","position":"Software Development Intern","location_type":"On site","location":"Boone, North Carolina","url":"https://www.samaritanspurse.org","startDate":"2023-05-01","endDate":"2023-08-04","summary":"Launched a major application, developed features and bug fixes, and improved data validation at Samaritan's Purse.","responsibilities":["Oversaw the launch of a significant ministry application.","Independently developed and deployed 14 feature releases and bug fixes for an internal-facing CRM application, which serves hundreds of users.","Implemented UI and backend features using Angular Typescript and C# to ensure validity and enhance UX.","Designed and implemented account data validator that accurately flagged over 500k accounts.","Increased data validator load and running efficiency by over 4x times."],"achievements":["Launched a major ministry application.","Developed and deployed 14 feature releases and bug fixes for an internal-facing CRM application.","Implemented account data validator that accurately flagged over 500k accounts.","Increased data validator load and running efficiency by over 4x times."],"skills":["Web Development","Angular","Typescript","C#","UI Design","MySQL","Data Validation"]}];
...
const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "vercel-speed-insights", "vercel-speed-insights", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/home/user/portfolio/node_modules/.pnpm/@vercel+speed-insights@1.3.1/node_modules/@vercel/speed-insights/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/user/portfolio/node_modules/.pnpm/@vercel+speed-insights@1.3.1/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
...
}, "/home/user/portfolio/src/components/Section.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/About.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/Education.astro", void 0);
...
}, "/home/user/portfolio/src/icons/javascript.astro", void 0);
...
}, "/home/user/portfolio/src/icons/type.astro", void 0);
...
}, "/home/user/portfolio/src/icons/react.astro", void 0);
...
}, "/home/user/portfolio/src/icons/node.astro", void 0);
...
}, "/home/user/portfolio/src/icons/sql.astro", void 0);
...
}, "/home/user/portfolio/src/icons/git.astro", void 0);
...
}, "/home/user/portfolio/src/icons/GitHub.astro", void 0);
...
}, "/home/user/portfolio/src/icons/tailwind.astro", void 0);
...
}, "/home/user/portfolio/src/icons/next.astro", void 0);
...
}, "/home/user/portfolio/src/icons/swift.astro", void 0);
...
}, "/home/user/portfolio/src/icons/swiftui.astro", void 0);
...
}, "/home/user/portfolio/src/icons/kotlin.astro", void 0);
...
}, "/home/user/portfolio/src/icons/flutter.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/Experience.astro", void 0);
...
}, "/home/user/portfolio/src/icons/Mail.astro", void 0);
...
}, "/home/user/portfolio/src/icons/Phone.astro", void 0);
...
}, "/home/user/portfolio/src/icons/X.astro", void 0);
...
}, "/home/user/portfolio/src/icons/LinkedIn.astro", void 0);
...
}, "/home/user/portfolio/src/icons/WorldMap.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/Projects.astro", void 0);
...
}, "/home/user/portfolio/src/icons/Figma.astro", void 0);
...
}, "/home/user/portfolio/src/icons/Gitlab.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/Skills.astro", void 0);
...
}, "/home/user/portfolio/src/components/sections/Tail.astro", void 0);
...
</footer> -->${maybeRenderHead()}<div class="footer-button no-print" data-astro-cid-5uazswxx> <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-command" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#777" fill="none" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-5uazswxx> <path stroke="none" d="M0 0h24v24H0z" fill="none" data-astro-cid-5uazswxx></path> <path d="M7 9a2 2 0 1 1 2 -2v10a2 2 0 1 1 -2 -2h10a2 2 0 1 1 -2 2v-10a2 2 0 1 1 2 2h-10" data-astro-cid-5uazswxx></path> </svg> </div> <div id="hotkeypad" data-placeholder="Search Command"${addAttribute(JSON.stringify(profilesInfo), "data-info")} data-astro-cid-5uazswxx></div> ${renderScript($$result, "/home/user/portfolio/src/components/KeyboardManager.astro?astro&type=script&index=0&lang.ts")} `;
}, "/home/user/portfolio/src/components/KeyboardManager.astro", void 0);
...
}, "/home/user/portfolio/src/pages/index.astro", void 0);

const $$file = "/home/user/portfolio/src/pages/index.astro";
const $$url = "";
